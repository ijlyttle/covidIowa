04-explore
================
Compiled at 2021-02-28 18:06:17 UTC
...
```
    ...
    ## # … with 27,123 more rows, and 4 more variables: cases_total_per100k <dbl>,
...
write_csv(
  iowa_county_cases_week_current, 
  path_target("iowa_county_cases_week_current.csv")
)
```
...
```
    ...
    ## 1 iowa_cases.png                     file      203.73K 2021-02-28 18:06:23
    ## 2 iowa_cases_week.csv                file       14.77K 2021-02-28 18:06:23
    ## 3 iowa_change.png                    file      180.63K 2021-02-28 18:06:23
    ## 4 iowa_county_cases_week_current.csv file        6.94K 2021-02-28 18:06:23
