...
iowa_county_cases_week_current <- 
  read_csv(
    ...
    col_types = readr::cols(
      ...
      population_group = readr::col_character(),
      cases_total = readr::col_double(),
      cases_total_per100k = col_double(),
      cases_avg_week = readr::col_double(),
      cases_avg_week_per100k = readr::col_double(),
      cases_week_growth = readr::col_double()
    )
  ) %>%
